...
const Admin = () => {
  ...
  const [showModifyStudent, setShowModifyStudent] = useState(false);
  ...
  return (
    <div className="admin-dashboard">
      ...
      <div className="admin-card-container">
        ...
        <div className="admin-card">
          ...
          <div>
            ...
            <button onClick={() => setShowModifyStudent(true)}>
      ...
      {showModifyStudent && (
        <ModifyStudentModal onClose={() => setShowModifyStudent(false)} />
      )}
