...
def get_available_equipment(id):
    '''
    devuelve una lista con la infromación del equipamiento que podes tener para esta clase.
    - (description, cost, id)
    '''
...
def roll_call(id):
    ...
    #     print("este error")
    #     return jsonify({'error': 'Es necesario ingresar los ids de los estudiantes que fueron parte.'}), 400
